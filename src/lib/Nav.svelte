   ...
   <div class="bg-white/0 px-10">
      ...
      <div class="flex h-24 flex-row items-center justify-between">
         <div class="flex flex-row items-center">
            ...
            <a href="/track/7gVwgc8b3XnO87TpmXXFA5" class="px-2 text-[#091834] transition duration-300 ease-in-out hover:-translate-y-1"
               >discover 💡</a>
            <a href="/track/7gVwgc8b3XnO87TpmXXFA5" class="px-2 text-[#091834] transition duration-300 ease-in-out hover:-translate-y-1">about ℹ️</a>
