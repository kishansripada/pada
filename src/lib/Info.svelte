...
{#if currentVersion}
   <div class="flex h-24 flex-row rounded-[20px] bg-white/10 text-[#091834] shadow-2xl ">
      ...
      <div class="ml-auto flex flex-col py-2 pr-3">
         ...
         <select
            ...
            class=" form-select mt-auto ml-auto w-24 appearance-none rounded-[20px] border bg-white/5 bg-clip-padding px-2 py-1.5 text-center text-base font-normal text-[#091834] outline-none hover:bg-white/10">
